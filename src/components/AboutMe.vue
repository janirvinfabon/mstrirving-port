  ...
  <div class="max-w-7xl m-center pt-20 pb-20">
    ...
    >
      ...
      >
        ...
        >
        Hi 👋, My name is Jan. A seasoned software developer with 6 years of experience in the field. 
        Currently using my skills to create an innovative solutions using the latest technologies. 
        I am particularly proficient in utilizing the AWS Serverless framework in my projects, and 
        I constantly strive to expand my knowledge and skills.
        </div>
        <div
        ...
        <div class="resume pt-10">
          <button class="btn-accent flex items-center m-auto lg:m-0">
            <a
              href="https://drive.google.com/file/d/1-7RAcI86iM0e4F71QxxRnZMtFYEIVTWB/view?usp=drive_link"
              target="_blank"
            >
              Download CV&nbsp;
              <span
